...
import xupt.se.ttms.view.usecase.seat.SeatChooseUI;


public class SellTicketUI extends MenuUITmpl {
	/**
	 * 
	 */
...
//	private JPanel middlePanel;
	...
	private void btnChoClicked() {
		SeatChooseUI addMovie = new SeatChooseUI();
...
//		salePanel3.add(upPanel, BorderLayout.NORTH);
	...
	private void getTickets(DefaultMutableTreeNode node){
        ...
        if(node!=null && node.isLeaf()){
    		...
    		SeatChooseUI Seat = new SeatChooseUI();
