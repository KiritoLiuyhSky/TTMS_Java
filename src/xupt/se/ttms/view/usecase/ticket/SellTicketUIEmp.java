...
import xupt.se.ttms.view.usecase.seat.SeatChooseUIEmp;


public class SellTicketUIEmp extends MenuUITmplEmp {
	/**
	 * 
	 */
...
//	private JPanel middlePanel;
	...
	public SellTicketUIEmp() {
	}
	
	public SellTicketUIEmp(String name, int id) {
		super(name, id);
		username = name;
		userid = id;
		//initContent();
	...
	private void btnChoClicked() {
		SeatChooseUIEmp addMovie = new SeatChooseUIEmp();
...
//		salePanel3.add(upPanel, BorderLayout.NORTH);
	...
	private void getTickets(DefaultMutableTreeNode node){
        ...
        if(node!=null && node.isLeaf()){
    		...
    		SeatChooseUIEmp Seat = new SeatChooseUIEmp();
	...
	public static void main(String[] args) {
		SellTicketUIEmp frmStuMgr = new SellTicketUIEmp(username, userid);
