...
public class CustomerAddUI extends PopUITmpl implements ActionListener {
	...
	private JLabel lblNick, lblPsd, lblName, lblEmail, lblSex, lblDate, lblAge, lblPhone, lblIntro;
	protected JTextField txtNick, txtPsd, txtName, txtEmail, txtSex, txtDate, txtAge, txtPhone;
	...
	protected void initContent(){
		...
		lblEmail.setBounds(415, 130, 140, 30);
		lblEmail.setFont(new Font("华文行楷", 1, 15));
		contPan.add(lblEmail);
		txtEmail = new JTextField();
		txtEmail.setBounds(500, 130, 180, 30);
