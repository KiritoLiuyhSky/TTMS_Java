...
public class ScheduleTableUI extends PopUITmplEmp {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
...
//	private JPanel salePanel;
	...
	public ScheduleTableUI(String name,int id) {
		super(name,id);
		username = name;
		userid = id;
		initContent();
	...
	public static void main(String[] args) {
		ScheduleTableUI frmStuMgr = new ScheduleTableUI(username,userid);
