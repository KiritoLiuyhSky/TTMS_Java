...
public class MenuUITmpl extends JFrame  {
...
//		this.add(background);
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					new MainUITmpl("name").setVisible(true);;
...
//		String name = curUser.getEmpName();
	...
	protected void btnExitClicked(ActionEvent Event){
		ClerkMenuFrame customerMenuFrame = new ClerkMenuFrame();
