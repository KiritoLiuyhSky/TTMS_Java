...
public class MenuUITmplEmp extends JFrame  {
...
//		this.add(background);
	...
	public MenuUITmplEmp(String name, int id){
		this.setSize(frmWidth, frmHeight);
		this.setLocationRelativeTo(null);
		this.setResizable(false);
		this.setTitle("这就是命剧院票务管理系统");
...
//		String name = curUser.getEmpName();
	...
	protected void btnExitClicked(ActionEvent Event){
		EmpMenuFrame customerMenuFrame = new EmpMenuFrame(username, userid);
